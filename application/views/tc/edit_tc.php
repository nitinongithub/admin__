...
<div class="col-lg-12">
    <div class="panel panel-default"<?php //echo $style_; ?>>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-6">
                    <?php echo form_open_multipart('tc/updateTC/'.$tcEditData->TCID.'/'.$tcEditData->detid.'/'.$thisYear.'/'.$limit_, array('name' => 'frmTC', 'id' => 'frmTC', 'role' => 'form')); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                $data = array(
                                    ...
                                    'id' => 'txtAdmissionDate',
                                    'value' => $tcEditData->ADMISSION_DATE,
                                    'style' => 'color: #ff9000'
                                );
                                echo form_input($data);
                                ?>
                            ...
                            <div class="col-sm-6">
                                ...
                                $data = array(
                                    ...
                                    'value' => $tcEditData->ADMISSION_CLASS,
                                    'style' => 'color: #ff9000'
                                );
                                echo form_input($data);
                                ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                $data = array(
                                    ...
                                    'id' => 'txtLeavingClass',
                                    'value' => $tcEditData->LEAVING_CLASS,
                                    'style' => 'color: #ff9000'
                                );
                                echo form_input($data);
                                ?>
